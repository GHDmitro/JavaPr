...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Gson gson = new GsonBuilder().create(); // штука для сереолизации десереолизации
        JSON json = (JSON) gson.fromJson(result, JSON.class); // JSON.class root для нашего класса ( для архетиктуры)
